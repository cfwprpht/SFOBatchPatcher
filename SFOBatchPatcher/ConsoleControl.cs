...
namespace ConsoleControl
{
    ...
    public partial class ConsoleControl : UserControl
    {
        ...
        public ConsoleControl()
        {
            ...
            //  Write all In-Output to a Log file, disabled by default.
            IsLogEnabled = false;
            ...
            //  Handle events.
            richTextBoxConsole.LinkClicked += new LinkClickedEventHandler(richTextBoxConsole_OnLinkClicked);
        ...
        /// <param name="e"></param>
        private void richTextBoxConsole_OnLinkClicked(object sender, LinkClickedEventArgs e)
        {
            // Open the link in user's prefered browser
        ...
        /// <param name="args">The "ProcessInterface.ProcessEventArgs" instance containing the event data.</param>
        ...
        void processInterace_OnProcessExit(object sender, ProcessInterface.ProcessEventArgs args)
        {
            ...
            if (ShowDiagnostics)
            {
                WriteOutput(System.Environment.NewLine + processInterace.ProcessFileName + " exited.\n\n", Color.FromArgb(255, 0, 255, 0));
            }
...
//WriteInput("\x3", Color.White, false);
        ...
        public void WriteOutput(string output, Color color)
        {
            ...
            if (IsLogEnabled)
            {
                //  If yes, we pipe the Output to our own Log File.
                Logger.WriteText(pathToLogFile, output);
            }
        }
        ...
        public void WriteInput(string input, Color color, bool echo)
        {
            ...
            if (IsLogEnabled)
            {
                //  If yes, we pipe the Input to our own Log File.
                Logger.WriteText(pathToLogFile, "INPUT: " + input + "\n\n");
            }
        }
        ...
        public void StartProcess(string fileName, string arguments)
        {
            ...
            if (ShowDiagnostics)
            {
                ...
                if (!string.IsNullOrEmpty(arguments))
                    WriteOutput(" with arguments " + arguments + ".\n\n" + Environment.NewLine, Color.FromArgb(255, 0, 255, 0));
                else
                    WriteOutput(".\n\n" + Environment.NewLine, Color.FromArgb(255, 0, 255, 0));
            }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to log all In-Output or not.
        /// </summary>
        /// <value>
        ///   <c>true</c> if log In-Output; otherwise, <c>false</c>.
        /// </value>
        [Category("Console Control"), Description("Log all In-Output.")]
